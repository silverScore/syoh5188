...
urlpatterns = [
    ...
    # path('<int:pk>/reviews/add/', views.ReviewCreateView.as_view(), name='review_create'), # '<int:pk>/review/add/'
    path('care/<int:care_id>/reviews/add/', views.ReviewCreateView.as_view(), name='review_create'),
